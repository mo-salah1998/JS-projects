    ...
    return (
        <div className="App ">
            <div className="transition-all duration-500 bg-white dark:bg-gray-800 text-blue-50 ">
                <div className="pt-6">
                    <nav aria-label="Breadcrumb" className="grid grid-cols-2 ">
                        <ol
                            className="flex flex-wrap items-center max-w-2xl px-4 space-x-2  gap-x-10 sm:px-6 lg:max-w-7xl lg:px-8 basis-4/12">
                            <li>
                            ...
                            <li>
                                <div className="flex items-center">
                                    <a href="#" className="mr-2 text-sm font-medium text-gray-900 dark:color-white">Clothing</a>
                                    <svg width="16" height="20" viewBox="0 0 16 20" fill="currentColor"
                                         aria-hidden="true"
                                         className="w-4 h-5 text-gray-300">
                                        <path d="M5.697 4.34L8.98 16.532h1.327L7.025 4.341H5.697z"/>
                    ...
                    <div
                        ...
                        <div className="lg:col-span-2 lg:border-r lg:border-gray-200 lg:pr-8">
                            <h1 className="text-2xl font-bold tracking-tight text-gray-900 dark:color-white sm:text-3xl">Basic Tee
                                6-Pack</h1>
                        </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <div className="space-y-6">
                                    <p className="text-base text-gray-900 dark:color-white ">The Basic Tee 6-Pack allows you to fully
                                        express
                                ...
                                <div className="mt-4">
                                    <ul className="pl-4 space-y-2 text-sm list-disc">
                                        ...
                                        <li className="text-gray-400 dark:color-white"><span
                                            className="text-gray-600 dark:color-white">Pre-washed &amp; pre-shrunk</span></li>
                                        <li className="text-gray-400 dark:color-white"><span
                            ...
                            <div className="mt-10">
                                ...
                                <div className="mt-4 space-y-6">
                                    <p className="text-sm text-gray-600 dark:color-white ">The 6-Pack includes two black, two white, and
                                        two
