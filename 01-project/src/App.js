...
function App() {
    ...
    let svgIcon = () => {
        if (dark === true) {
            return <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
            ...
            return <svg className="w-6 h-6 text-white dark:text-white" aria-hidden="true"
            ...
            <div className="pt-6 ">
                <nav aria-label="Breadcrumb" className="grid grid-cols-2 max-w-2xl lg:max-w-7xl mx-auto ">
                    ...
                    <button value={dark} onClick={changeTheme}
                            className="themeBtn">{svgIcon()}  </button>
                </nav>
